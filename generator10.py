...
template_path = "templates/cert-turkey .jpeg"
...
for i, row in df.iterrows():
    ...
    draw.text((748, 450), full_name, font=font_name, fill=white, anchor="mm")
    ...
    # 🔗 QR CODE
    # ===============================
    qr = qrcode.make(verify_link).resize((70, 70))
    img.paste(qr, (498, 837))
