...
DATA_FILE = "output/final_data10.csv"
...
def cert(username):
    return f"/output/certificates10/{username}.png"


from flask import send_from_directory

@app.route('/certificates10/<path:filename>')
def serve_certificate(filename):
    return send_from_directory('output/certificates10', filename)
